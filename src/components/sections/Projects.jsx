...
const documents = [
  ...
  },
  {
    ...
    story: {
      ...
      impact:
        "In testing, it uncovered a full attack chain of credential stuffing, brute force, lateral movement, and database compromise that static rules miss.",
    },
  },
  {
  ...
  },
  {
    ...
    story: {
      ...
      impact:
        "It proved the idea: one developer-built dashboard consolidating live prices and trending data without overwhelming the user. Honestly an early-stage product with no on-chain analysis, whale tracking or portfolio tools yet, but the architecture validated the real-time workflow and gave later iterations a foundation worth building on.",
    },
  },
];
  ...
  return (
    ...
    >
      {STORY_SLOTS.map(({ key, label, hint }) => {
        ...
        return (
          <motion.div key={key} variants={row}>
          ...
          <figure className="group">
            <div className="overflow-hidden border-[1.5px] border-ink">
              <img
                ...
                loading="lazy"
                className="aspect-[16/10] w-full object-cover object-top transition-transform duration-700 ease-[var(--ease-crisp)] group-hover:scale-[1.03] motion-reduce:transition-none motion-reduce:group-hover:scale-100"
              />
            </div>
...
export const Projects = () => {
  ...
  return (
  <section id="projects" className="relative scroll-mt-16 px-6 py-20 md:py-24">
